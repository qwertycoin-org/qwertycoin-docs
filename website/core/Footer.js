...
class Footer extends React.Component {
  ...
  render() {
    const repoUrl = `https://github.com/qwertycoin-org/qwertycoin-docs`
    return (
      <footer className="nav-footer" id="footer">
        <section className="sitemap">
          ...
          <div>
            <h5>Community</h5>
            <a href="https://discordapp.com/invite/kMykjNQ">Discord Chat</a>
            <a href="https://www.reddit.com/r/QWERTYCOIN/">Reddit</a>
            <a
              href="https://twitter.com/Qwertycoin_QWC"
              target="_blank"
          ...
          <div>
            <h5>More</h5>
            <a href="https://qwertycoin.org/blog">Blog</a>
